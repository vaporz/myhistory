...
public class NewsController {
	 ...
	 */
	@Post("news/commit")
	public String commitNews(Invocation inv, @Param("url") String url, @Param("title") String title,
			@Param("content") String content, @Param("keywords") String keywords, @Param("newTime") String newTimeStr)
	...
	public String listNewsByKeyword(Invocation inv, @Param("keywordId") long keywordId,
			@Param("newsTime") long newsTime, @Param("limit") int limit) throws BadRequestException {
