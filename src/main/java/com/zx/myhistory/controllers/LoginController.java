...
public class LoginController {
	...
	@Post("register")
	public String register(Invocation inv, @Param("name") String name, @Param("pwd") String pwd,
			@Param("pwd2") String pwd2, @Param("email") String email) throws BadRequestException {
		if (StringUtils.isBlank(name) || StringUtils.isBlank(pwd)) {
