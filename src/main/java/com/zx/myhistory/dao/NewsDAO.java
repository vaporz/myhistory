...
public interface NewsDAO {
	...
	@ReturnGeneratedKeys
	public Long commitNews(@SQLParam("title") String title, @SQLParam("content") String content,
	...
	@ReturnGeneratedKeys
	public Long insertKeyword(@SQLParam("keyword") String keyword,
	...
	public void insertNewsKeyword(@SQLParam("newsId") long newsId, @SQLParam("keywordId") long keywordId,
			@SQLParam("keyword") String keyword, @SQLParam("keywordLowercase") String keywordLowercase,
