...
public interface CommentDAO {
    ...
    public void insertComment(@SQLParam("commentId") long commentId, @ShardBy @SQLParam("newsId") long newsId,
        @SQLParam("userId") long userId, @SQLParam("userName") String userName, @SQLParam("userIcon") String userIcon,
        @SQLParam("content") String content, @SQLParam("createTime") long createTime);
    ...
    public List<Comment> getComments(@ShardBy @SQLParam("newsId") long newsId, @SQLParam("createTime") long createTime,
        @SQLParam("limit") int limit);

    @SQL("DELETE FROM news_comment WHERE comment_id=:commentId")
    public void deleteComment(@ShardBy @SQLParam("newsId") long newsId, @SQLParam("commentId") long commentId);
